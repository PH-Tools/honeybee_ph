...
ph_properties.operating_periods.high = _op_period_high or honeybee_energy_ph.properties.ruleset.OperationPeriod(0, 0)
ph_properties.operating_periods.standard = _op_period_standard or honeybee_energy_ph.properties.ruleset.OperationPeriod(0, 0)
ph_properties.operating_periods.basic = _op_period_basic or honeybee_energy_ph.properties.ruleset.OperationPeriod(0, 0)
ph_properties.operating_periods.minimum = _op_period_minimum or honeybee_energy_ph.properties.ruleset.OperationPeriod(0, 0)
