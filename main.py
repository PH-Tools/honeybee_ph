...
# ------------------------------------------------------------------------------
SOURCE_FILE = pathlib.Path("sample", "hbjson", "Townsend_St_Input_220104.hbjson")
TARGET_FILE_XML = pathlib.Path("sample", "wufi_xml", "Townsend_St_Input_220104.xml")

# --- Read in an existing HB_JSON and re-build the HB Objects
# ------------------------------------------------------------------------------
print("[red]- [/red]" * 50)
print(f"[bold red]> Reading in the HBJSON file: [/bold red]./{SOURCE_FILE}")
...
# # ----------------------------------------------------------------------------
print(f"[bold red]> Generating XML Text for the Honeybee Model: [/bold red][{hb_model}]")
xml_txt = to_WUFI_XML.xml_builder.generate_WUFI_XML_for_Project(wufi_Project)

print(f"[bold red]> Saving the XML file to: [/bold red]./{TARGET_FILE_XML}")
