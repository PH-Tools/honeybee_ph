...
| 02 | Replace constructed defaults and implement recursive duplication | Phase 01 regression matrix complete | **Next** |
| 03 | Verify HBJSON, host-object behavior, docs, full suite, and release | Phase 02 focused tests green | Pending |
