...
| Retire `ElectricEquipmentPhProperties.equipment_collection` | Deprecation (cross-repo, **primary**) | **Steps 1 to 3 released; Rhino check open** — step 3 released in v1.33.66 ([#126](https://github.com/PH-Tools/honeybee_ph/pull/126)); step 1 released in v1.33.65 ([#124](https://github.com/PH-Tools/honeybee_ph/pull/124)); PHX dropped its reads in 1.56.108 ([PHX#124](https://github.com/PH-Tools/PHX/issues/124)); GH deleted the dead component on main ([honeybee_grasshopper_ph#84](https://github.com/PH-Tools/honeybee_grasshopper_ph/issues/84), unreleased; the released component raises before touching the attribute). Step 3 removes the public attribute and `PhEquipmentCollection`; legacy devices sit in private `_legacy_equipment` until the load-time migration clears them. Still not loaded in Rhino (IronPython 2.7) | [#79](https://github.com/PH-Tools/honeybee_ph/issues/79) | [decision 0009](../context/decisions/0009-legacy-equipment-collection-migrates-on-load.md) |
