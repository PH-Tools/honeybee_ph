...
| Retire `ElectricEquipmentPhProperties.equipment_collection` | Deprecation (cross-repo, **primary**) | **In progress** — step 1 of 3 **released in v1.33.65** ([#124](https://github.com/PH-Tools/honeybee_ph/pull/124)): legacy collections migrate onto Process loads on load, `to_dict()` stops writing the key. Not yet loaded in Rhino (IronPython 2.7). Then PHX drops its reads and releases ([PHX#124](https://github.com/PH-Tools/PHX/issues/124)) and GH deletes the dead component ([honeybee_grasshopper_ph#84](https://github.com/PH-Tools/honeybee_grasshopper_ph/issues/84)); then the attribute is removed here | [#79](https://github.com/PH-Tools/honeybee_ph/issues/79) | [decision 0009](../context/decisions/0009-legacy-equipment-collection-migrates-on-load.md) |
