...
| `Space.from_room()` default-space factory (upstream from GH) | Feature (cross-repo, **primary**) | **Implementing** — Phases 01-02 complete; integration/docs verification next | [`features/space-from-room-factory/`](features/space-from-room-factory/README.md) |
