...
| [0009](0009-legacy-equipment-collection-migrates-on-load.md) | Legacy `ElectricEquipmentPhProperties.equipment_collection` migrates onto Process loads from the `ph` Model and Room load hooks; `to_dict()` stops writing it | Decided 2026-09-12 |
