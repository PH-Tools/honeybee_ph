...
#
"""
Assign Honeybee Rooms to a specific 'Building Segment' within the PHX Model. In WUFI, this is used
...
# -- Monthly
ph_climate_.monthly_temperature_air.values = [
    1.2, -0.2, 5.6, 10.9, 16.1, 21.7, 25.0, 24.8, 19.9, 14.0, 7.3, 3.3]
ph_climate_.monthly_temperature_dewpoint.values = [-4.3, -
                                                   7.4, 0.3, 4.7, 9.1, 15.8, 20.3, 17.1, 13.2, 7.9, 2.1, -2.8]
ph_climate_.monthly_temperature_sky.values = [-17.4, -20.0, -
                                              10.9, -4.8, 1.0, 9.8, 14.5, 8.4, 5.8, -2.8, -8.6, -11.4]

ph_climate_.monthly_radiation_north.values = [
    21, 29, 34, 39, 56, 60, 59, 50, 34, 30, 20, 16]
ph_climate_.monthly_radiation_east.values = [
    32, 46, 57, 65, 82, 76, 78, 84, 60, 54, 33, 28]
ph_climate_.monthly_radiation_south.values = [
    83, 106, 103, 86, 80, 73, 78, 104, 97, 129, 87, 87]
ph_climate_.monthly_radiation_west.values = [
    48, 70, 92, 95, 114, 121, 120, 130, 91, 94, 47, 45]
ph_climate_.monthly_radiation_global.values = [
    50, 72, 111, 133, 170, 176, 177, 182, 124, 109, 62, 46]
...
if copy_from_excel_:
    ph_climate_ = honeybee_ph_rhino.climate.parse_copy_from_excel(
        ph_climate_, copy_from_excel_)
