...
These Operating Periods are used in the creation of HB-PH Schedules.
-
EM January 29, 2022
    Args:
...
# ------------------------------------------------------------------------------
op_period_ = honeybee_energy_ph.properties.ruleset.DailyOperationPeriod()
op_period_.operation_hours = _hours_per_day or 0.0
op_period_.operation_fraction = _operating_fraction or 0.0
